...
const styles = StyleSheet.create({
  ...
  badgeText: { color: colors.plum, fontFamily: headingFont, fontWeight: "600", fontSize: 9, lineHeight: 12, textTransform: "uppercase", letterSpacing: 0.6 },
  ...
  category: { color: colors.green, fontFamily: headingFont, fontWeight: "600", fontSize: 10, textTransform: "uppercase", letterSpacing: 0.82 },
  tier: { color: colors.ink, fontFamily: mediumFont, fontWeight: "500", fontSize: 9, paddingVertical: 5, paddingHorizontal: 9, borderRadius: 10, backgroundColor: colors.mint },
  name: { color: colors.ink, fontFamily: headingFont, fontWeight: "600", fontSize: 24, lineHeight: 29, letterSpacing: -0.58, marginTop: 10 },
  detailRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginTop: 6 },
  locationRow: { flexDirection: "row", alignItems: "center", gap: 3 },
  location: { color: colors.muted, fontFamily: appFont, fontWeight: "400", fontSize: 11 },
  ratingRow: { flexDirection: "row", alignItems: "center", gap: 3 },
  rating: { color: colors.gold, fontFamily: boldFont, fontWeight: "700", fontSize: 11 },
  reviews: { color: colors.muted, fontFamily: appFont, fontWeight: "400" },
  reason: { color: colors.muted, fontFamily: appFont, fontWeight: "400", fontSize: 12, lineHeight: 18, marginTop: 13 },
  ...
  price: { color: colors.ink, fontFamily: headingFont, fontWeight: "600", fontSize: 14 },
  viewButton: { flexDirection: "row", alignItems: "center", gap: 6 },
  viewText: { color: colors.ink, fontFamily: mediumFont, fontWeight: "500", fontSize: 11 },
