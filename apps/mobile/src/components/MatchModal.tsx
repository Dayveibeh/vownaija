...
const styles = StyleSheet.create({
  ...
  headerCopy: { flex: 1 },
  kicker: { color: colors.green, fontFamily: headingFont, fontSize: 9, letterSpacing: 1.15 },
  headerTitle: { color: colors.ink, fontFamily: mediumFont, fontSize: 13, marginTop: 2 },
  skip: { color: colors.muted, fontFamily: appFont, fontSize: 11, paddingVertical: 10 },
  ...
  stepLabel: { color: colors.green, fontFamily: headingFont, fontSize: 9, letterSpacing: 1.1 },
  title: { color: colors.ink, fontFamily: headingFont, fontSize: 36, lineHeight: 42, letterSpacing: -0.9, marginTop: 10 },
  subtitle: { color: colors.muted, fontFamily: appFont, fontSize: 13, lineHeight: 20, marginTop: 9, marginBottom: 25 },
  options: { gap: 10 },
  ...
  choiceCopy: { flex: 1 },
  choiceText: { color: colors.ink, fontFamily: mediumFont, fontSize: 13 },
  choiceTextSelected: { color: colors.plum, fontFamily: headingFont },
  choiceDetail: { color: colors.muted, fontFamily: appFont, fontSize: 10, marginTop: 3 },
  ...
  pillText: { color: colors.muted, fontFamily: mediumFont, fontSize: 10 },
  ...
  summaryText: { flex: 1, color: colors.ink, fontFamily: appFont, fontSize: 11, lineHeight: 17 },
  ...
  continueText: { color: colors.white, fontFamily: headingFont, fontSize: 13 }
});
