...
function TrustItem({ symbol, fallback, text }: SymbolPair & { text: string }) { return <View style={styles.trustItem}><AppSymbol name={symbol} fallback={fallback} size={18} color="#F4B4A9" type="hierarchical" weight="semibold" /><Text style={styles.trustText}>{text}</Text></View>; }
...
const styles = StyleSheet.create({
  ...
  tabBar: { height: 74, position: "absolute", left: 12, right: 12, zIndex: 12, padding: 7, borderWidth: 1, borderColor: "rgba(228,231,222,0.95)", borderRadius: 38, backgroundColor: "rgba(255,255,255,0.98)", flexDirection: "row", alignItems: "center", shadowColor: "#24151B", shadowOpacity: 0.15, shadowRadius: 24, shadowOffset: { width: 0, height: 10 }, elevation: 12 },
  ...
  tabButtonActive: { flex: 1.48, paddingHorizontal: 7, borderWidth: 1, borderColor: "#DCE1D5", backgroundColor: "#E9ECE5", shadowColor: "#354028", shadowOpacity: 0.08, shadowRadius: 8, shadowOffset: { width: 0, height: 3 } },
  tabButtonActiveDark: { borderColor: "#464B3E", backgroundColor: "#33362E" },
  ...
  tabLabelActive: { color: colors.plum, fontWeight: "700" },
  ...
  profileLinkIcon: { width: 36, height: 36, borderRadius: 12, backgroundColor: colors.blush, alignItems: "center", justifyContent: "center" },
