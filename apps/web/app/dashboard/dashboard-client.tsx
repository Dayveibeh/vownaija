...
export default function DashboardClient({ profile }: { profile: { fullName: string; email: string; businessName: string } }) {
  ...
  return (
    <main className="dashboard-shell">
      <aside className={mobileNav ? "dashboard-sidebar mobile-open" : "dashboard-sidebar"}>
        ...
        <div className="vendor-switcher"><span>{initials}</span><div><strong>{profile.businessName}</strong><small>Vendor workspace</small></div><ChevronDown size={16} /></div>
        <nav>
