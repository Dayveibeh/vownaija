    ...
    <main className="dashboard-shell">
      <aside className={mobileNav ? "dashboard-sidebar mobile-open" : "dashboard-sidebar"}>
        ...
        <nav>
          ...
          <button><BarChart3 size={18} /> Insights</button>
        </nav>
        <div className="sidebar-bottom"><button><Settings size={18} /> Settings</button><Link href="/vendor/aurora-events"><ArrowRight size={17} /> View public profile</Link></div>
      </aside>
...
function Overview({ setTab, openQuote }: { setTab: (tab: Tab) => void; openQuote: () => void }) {
  return <>
